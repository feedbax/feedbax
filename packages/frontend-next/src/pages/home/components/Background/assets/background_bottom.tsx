...
type SvgStyles = { ccss: Interpolation<Theme> };

export default memo(
  function Svg({ ccss }: SvgStyles): JSX.Element {
    return (
      <svg css={ccss} viewBox="0 0 414 212" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
